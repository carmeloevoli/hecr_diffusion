...
const double cash_karp_a[] = { 0., 0., 0., 0., 0., 0., 1. / 5., 0., 0., 0., 0., 0., 3. / 40., 9. / 40., 0., 0., 0., 0.,
		3. / 10., -9. / 10., 6. / 5., 0., 0., 0., -11. / 54., 5. / 2., -70. / 27., 35. / 27., 0., 0., 1631. / 55296.,
		175. / 512., 575. / 13824., 44275. / 110592., 253. / 4096., 0. };
...
void PropagationCK::tryStep(const Y &y, Y &out, Y &error, double h, ParticleState &particle) const {
	std::vector<Y> k;
	k.reserve(6);
...
void PropagationCK::process(Candidate *candidate) const {
	...
	while (r > 1) {
		step = newStep;
		tryStep(yIn, yOut, yErr, step / c_light, current);
